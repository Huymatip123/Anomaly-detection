"""
LightGBM, CatBoost, and feature engineering for CIC-UNSW-NB15.
Run after XGBoost tuning (needs xgboost_best.json for feature engineering).
"""
...
try:
    ...
    print('(Run tune_xgboost.py first to generate xgboost_best.json)')
...
with open(f'{OUT_DIR}/tuning_results_others.json', 'w') as f:
    json.dump(results, f, indent=2)
print(f'\nResults saved to {OUT_DIR}/tuning_results_others.json')
